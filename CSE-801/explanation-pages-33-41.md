...
sequenceDiagram
    ...
    P1->>T: Register and get peer list
    T-->>P1: List of peers (P2, P3)
    P1->>P2: Connect and request chunks
    P2-->>P1: Send chunks (tit-for-tat)
    P1->>P3: Connect and upload chunks
    P3-->>P1: Send chunks in return
```
