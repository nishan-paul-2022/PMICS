...
![Simple Transport Protocol](../supplies/images/simple-transport-protocol.png)
...
![Mail Service Analogy](../supplies/images/mail-service-analogy.png)
...
![TCP Port Inversion](../supplies/images/tcp-port-inversion.png)
...
![UDP vs TCP Comparison](../supplies/images/udp-vs-tcp-comparison.png)

This pie chart shows the advantages: UDP wins on speed and simplicity, TCP on reliability.

## R5. Why is it that voice and video traffic is often sent over TCP rather than UDP in today's Internet? _(Hint: The answer we are looking for has nothing to do with TCP's congestion-control mechanism.)_
...
![Web Server Sockets](../supplies/images/web-server-sockets.png)
