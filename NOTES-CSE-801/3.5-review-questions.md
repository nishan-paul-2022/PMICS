...
![TCP Segment Structure](../supplies/images/tcp-segment-structure.png)

### Diagram: Telnet Sequence for 'R'

![Telnet Sequence for 'R'](../supplies/images/tcp-telnet-sequence.png)
...
![TCP Connection Teardown](../supplies/images/tcp-connection-teardown.png)
