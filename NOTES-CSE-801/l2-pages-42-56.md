...
- **Diagram** (Mermaid): A flowchart showing the flow from source to user.
  ![Multimedia Streaming](../supplies/images/multimedia-streaming.png)
...
- **Diagram** (Mermaid): A mind map showing challenges and solutions.
  ![Video Streaming Context](../supplies/images/video-streaming-context.png)
...
- **Diagram** (Mermaid): A sequence diagram for frames and coding.
  ![Video Coding](../supplies/images/video-coding.png)
...
- **Diagram** (Mermaid): A timeline flowchart.
  ![Streaming Stored Video](../supplies/images/streaming-stored-video.png)
...
- **Diagram** (Mermaid): A process flowchart for challenges.
  ![Streaming Challenges](../supplies/images/streaming-challenges.png)
...
- **Diagram** (Mermaid): A graph-like flowchart.
  ![Playout Buffering](../supplies/images/playout-buffering.png)
...
- **Diagram** (Mermaid): A state diagram for adaptation.
  ![DASH Streaming](../supplies/images/dash-streaming.png)
...
- **Diagram** (Mermaid): A network diagram.
  ![CDN Overview](../supplies/images/cdn-overview.png)
...
- **Diagram** (Mermaid): A simple interaction flowchart.
  ![Protocol Summary](../supplies/images/protocol-summary.png)
